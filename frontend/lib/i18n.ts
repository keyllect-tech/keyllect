...
export const translations = {
  ru: {
    ...
    contacts: {
      ...
      address: 'Адрес',
      addressValue: '2-й пр-д Кипчак 40/12',
      phone: 'Телефон',
      email: 'Email',
      workHours: 'Часы работы',
      workHoursValue: 'Пн-Сб: 11:00 - 21:00, Вс: Выходной',
  ...
  uz: {
    ...
    contacts: {
      ...
      address: 'Manzil',
      addressValue: 'Qipchoq 2-tor ko\'chasi, 40/12',
      phone: 'Telefon',
      email: 'Email',
      workHours: 'Ish vaqti',
      workHoursValue: 'Dushanba - Shanba 11:00 - 21:00 gacha, Yakshanba Dam',
